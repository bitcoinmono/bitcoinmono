...
- `export CC=gcc-8`
- `export CXX=g++-8`
- `git clone -b master --single-branch https://github.com/bitcoinmono/bitcoinmono`
- `cd bitcoinmono`
- `mkdir build`
- `cd build`
- `cmake ..`
